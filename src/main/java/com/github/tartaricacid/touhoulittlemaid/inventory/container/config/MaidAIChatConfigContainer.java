...
public class MaidAIChatConfigContainer extends AbstractMaidContainer {
    public static final MenuType<MaidAIChatConfigContainer> TYPE = IForgeMenuType.create((windowId, inv, data)
            -> new MaidAIChatConfigContainer(windowId, inv, data.readInt(), data.readNbt()));
    private static final int PLAYER_INVENTORY_SIZE = 27;

    private final CompoundTag configData;

    public MaidAIChatConfigContainer(int id, Inventory inventory, int entityId, @Nullable CompoundTag configData) {
