...
public class GlobalLootModifier extends GlobalLootModifierProvider {
    ...
    public void start() {
        ...
        addChestLootModifier("woodland_mansion", BuiltInLootTables.WOODLAND_MANSION, LootTableGenerator.VERY_RARE_BAUBLE);
        ...
        addChestLootModifier("spawn_bonus_chest", BuiltInLootTables.SPAWN_BONUS_CHEST, LootTableGenerator.SPAWN_BONUS_NORMAL_BACKPACK);
        ...
        addChestLootModifier("bastion_treasure", BuiltInLootTables.BASTION_TREASURE, LootTableGenerator.SHRINE_MIDDLE);
        addChestLootModifier("buried_treasure", BuiltInLootTables.BURIED_TREASURE, LootTableGenerator.SHRINE_MORE);
